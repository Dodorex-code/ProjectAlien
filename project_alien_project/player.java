...
public class player extends Actor
{
    ...
    public void act()
    {
        ...
        //text ausgabe
        this.getWorld().addObject(new Bullets_UI(), this.getWorld().getWidth()/2, 30);
        this.getWorld().showText("Bullets:" + bullets,this.getWorld().getWidth()/2, 30);
        this.getWorld().addObject(new Bullets_UI(), this.getWorld().getWidth()/2, 60);
        this.getWorld().showText("Score:" + Score,this.getWorld().getWidth()/2, 60);
    ...
    {
        return Greenfoot.getRandomNumber(2);
    }
